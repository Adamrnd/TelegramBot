...
public class MyFirstTelegramBot extends MultiSessionTelegramBot {
    public static final String NAME = "blegal1zer_bot"; // TODO: добавьте имя бота в кавычках
    public static final String TOKEN = "6764495089:AAEcKcGiWBTSK-aAI6UyBal5EL1c4RgNjEc"; //TODO: добавьте токен бота в кавычках
    ...
    public void onUpdateEventReceived(Update updateEvent) {
        ...
        if (getCallbackQueryButtonKey().equals("step_4_btn")){
            ...
            sendTextMessageAsync(STEP_5_TEXT, Map.of("Взять G0-Pro", "step_5_btn"));
        }
        if(getCallbackQueryButtonKey().equals("step_5_btn")){
            addUserGlory(40);
            sendPhotoMessageAsync("step_6_pic");
            sendTextMessageAsync(STEP_6_TEXT, Map.of("Побегать с GO-Pro! +40 славы","step_6_btn",
                    "Паркур с Go-Pro! +40 славы", "step_6_btn"));
        }
        ...
        if(getCallbackQueryButtonKey().equals("step_7_btn")){
            ...
            sendTextMessageAsync(STEP_8_TEXT, Map.of("Кот кто?","step_8_btn"));
        }
        ...
        if (getMessageText().equals("/glory")){
            String str = Integer.toString(getUserGlory());
            sendTextMessageAsync(str);
        }
    }
...
//if (getMessageText().equals("/start")) {
//        sendTextMessageAsync("Привет, будующий программист *Адам*!");
//        }
//        if (getMessageText().contains("bye")){
